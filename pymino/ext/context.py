...
class Context():
    ...
    def __read_image__(self, image: Union[str, BinaryIO]) -> BinaryIO:
        try:
            ...
            raise Exception("\033[91m\033[1mERROR:\033[0m Please provide a valid image URL or file path/name. "
                "The image must be in a format that can be opened and read by the 'open' function (e.g. JPG, PNG).")
